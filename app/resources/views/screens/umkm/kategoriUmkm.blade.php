...
@section('content')
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb" class="mb-1">
            <ol class="breadcrumb">
            <li class="breadcrumb-item active" aria-current="page">Kategori UMKM</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{ url('/umkm/kategori/add') }}" method="post">
                            @csrf
                                <div class="form-group mb-3">
                                    <label for="nama_kategori">Kategori UMKM</label>
                                    <input type="text" id="nama_kategori" value="{{old('nama_kategori')}}" class="form-control @error('nama_kategori') is-invalid @enderror" name="nama_kategori" placeholder="Kategori UMKM">
                                    @error('nama_kategori')
                    ...
                    <div class="card-header">
                        <div class="d-flex">
                            ...
                            <div class="w-100 text-end">
                                <a href="{{ url('/umkm/kategori') }}" class="btn btn-primary text-light btn-sm">Refresh Data <i class="bi bi-arrow-clockwise"></i></a>
                            </div>
                        </div>
                    </div>
