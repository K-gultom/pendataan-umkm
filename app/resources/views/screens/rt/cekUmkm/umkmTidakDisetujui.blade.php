...
@section('content')
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb" class="mb-1">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Data UMKM Tidak Disetujui</li>
            </ol>
        </nav>
            ...
            <div class="card-header">
                <div class="d-flex">
                    <div class="w-100 pt-1">
                        <strong>Data</strong> UMKM Tidak Disetujui
                    </div>
                    <div class="w-100 text-end">
                        <a href="{{url('/rt/tidak/disetujui')}}" class="btn btn-primary">
            ...
            <div class="card-body">
                @if($getData->isEmpty())
                    <div class="alert alert-danger">
                        Maaf, Tidak Ada UMKM yang <strong>Tidak Disetujui</strong>
                    </div>
                @else
