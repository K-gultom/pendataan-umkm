...
@section('content')
    <div class="container-fluid">
        <h4 class="mb-3">Surat Keterangan</h4>
            ...
            <div class="card-header">
                <div class="d-flex">
                    ...
                    <div class="w-100 text-end">
                        <a href="{{url('/surat-keterangan')}}" class="btn btn-primary">
                        ...
                        @foreach ($dataUmkm as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ url('/cetak-domisili') }}/{{ $item->id }}" class="btn btn-primary btn-sm">
                                        <i class="bi bi-printer"></i> Surat Domisili
                                    </a>
                                    <a href="{{ url('/cetak-pinjaman') }}/{{ $item->id }}" class="btn btn-warning btn-sm">
                                        <i class="bi bi-printer"></i> Surat Pinjaman Bank
                                    </a>
                                </td>
