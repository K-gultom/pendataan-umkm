...
<html lang="en">
    ...
    <body>
        ...
        <div class="ketiga tab" style="text-align: justify">
            <p>
                Sesuai Kartu Tanda Penduduk Nomor: {{ $getData->nik }} tanggal {{ Carbon\Carbon::now()->format('d-m-Y') }}
                adalah Penduduk dengan alamat tersebut diatas, dan Berdasarkan Surat Pernyataan yang diketahui oleh Ketua RT. {{ $getData->getRT->wilayah_rt }} 
                bahwa yang bersangkutan mempunyai Usaha {{ $getData->getKategori->nama_kategori }} {{ $getData->alamat_usaha }}
                Kel. Sembilan Ilir, Kec. Ilir Timur Tiga Palembang

            </p>
            <p>
                Surat Keterangan ini diberikan sebagai persyaratan mengajukan administrasi Mengajukan Pinjaman di Bank .............
            </p>
        </div>
