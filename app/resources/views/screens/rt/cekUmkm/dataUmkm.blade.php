                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        @foreach ($getApprove as $item)
                            ...
                            <form action="{{ url('/rt/umkm') }}" method="post">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-3">
                                        <input class="" type="radio" name="status" id="disetujui" value="Disetujui"> 
                                        <label for="disetujui">Disetujui</label>
                                    </div>
                                    <div class="col-4">
                                        <input type="radio" name="status" id="tidakdisetujui" value="Disetujui"> 
                                        <label for="tidakdisetujui">Tidak Disetujui</label>
                                    </div> --}}

                                    <div class="col-3">
                                        <input class="" type="radio" name="status" id="disetujui" value="Disetujui" {{ $item->status == 'Disetujui' ? 'checked' : '' }}>
                                        <label for="disetujui">Disetujui</label>
                                    </div>
                                    <div class="col-4">
                                        <input type="radio" name="status" id="tidakdisetujui" value="Tidak Disetujui" {{ $item->status == 'Tidak Disetujui' ? 'checked' : '' }}>
                                        <label for="tidakdisetujui">Tidak Disetujui</label>
                                    </div>
